...
<section id="aktor" class="aktor">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <ol>
                <li><a href="/">Home</a></li>
                <li style="color: #0095ce;">Hasil seleksi</li>
            </ol>
        </div>
    </div>
</section><!-- AKHIR AKTOR -->
        ...
        <div class="content">
            <div class="row counters">
                <div class="col-lg-12 text-center" style="padding-top: 20px;">
                    <h2>Jumlah Seleksi <?= count($pendaftar);?> Siswa</h2>
                </div><br>
            </div>
        </div>
    </div>
...
<div class="halaman-sekolah" style="margin-top: 50px;">
    <!--HASIL-->
    <div class="container">
        <h3 style="text-align: center;">HASIL SELEKSI</h3><br>
        ...
        <div class="table-responsive">
            <table border="1" style="margin-left:180px; margin-bottom: 100px;" id="myTable" cellspacing="0"
                ...
                <tr class="header">
                    ...
                    <th scope="col">BERHASIL DITERIMA</th>
                    <th scope="col">NEM</th>
                </tr>
                <?php $no = 1;
          foreach ($pendaftar as $d) : ?>
                <tr>
                    ...
                    <td><?php $num = (int) $d->id_sekolah_lulus; echo $sekolah[$num-1]['nama_sekolah']; ?></td>
                    <td><?= $d->nem; ?></td>
                </tr>
                <?php endforeach; ?>
            </table>
