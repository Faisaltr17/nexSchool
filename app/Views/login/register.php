...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2 style="font-size:30pt;margin-top: 3em;margin-bottom: 0.5em; color: #303030;font-weight: bold;font-style:normal;">Register Account</h2>
            <h4 style="color: #8692A6; margin-bottom:2em;">For the purpose of School regulation, your details are required.</h4>
            <h4>
                <?= $validation->listErrors() ?>
            </h4>
            <form class="form-login" action="/registrasi" method="post">
                <!-- <label style="color: #696F79;font-style: normal;font-weight: 500; font-size: 16px;">Nama Lengkap</label><br><br>
                ...
                <input type="text" class="t-input" name="username" placeholder="Enter Username" id="Username" autofocus required><br>
                ...
                <button type="submit" class="submit-button" name="submit-regis">
                    <a href="" style="text-decoration: none; color: #FFFFFF;font-style: normal;font-weight: 500;font-size: 16px;"> Register Account </a>
                </button>
            </form>
        </div>
    </div>
