...
<head>
    ...
    <title>Daftar.in - Login Siswa</title>
</head>
<body>
    <div class="container">
        <a href="">
        ...
        <div class="content">
            ...
            <?php endif; ?>
            <form class="form-login" action="/login/siswa/proses" method="post">
                ...
                <button type="submit" class="submit-button" name="submit-regis">
                    <p href="" style="text-decoration: none; color: #FFFFFF;font-style: normal;font-weight: 500;font-size: 16px;"> Login </p>
                </button><br><br>
